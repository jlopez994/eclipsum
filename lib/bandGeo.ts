/** Generado por scripts/genBand.ts — banda de totalidad 2026-08-12 (no editar a mano). */
...
/**
 * Bandas empaquetadas por id de eclipse. Para un eclipse nuevo:
 * `npx tsx scripts/genBand.ts --id <id> --export BAND_XXXX` y registrar aquí.
 * Eclipses solo-RC sin banda: el mapa real pinta marcadores sin polígono.
 */
